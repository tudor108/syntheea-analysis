...
def write_dashboard(journey: pd.DataFrame, report_dir: str | Path) -> Path:
    ...
    </style></head><body><main class="page"><header><h1>Prostate Patient Journey – Cohort Dashboard</h1><p>Market, eligibility, pathway, treatment and censoring signals generated from the gold patient journey table.</p><p>Generated: {generated} · Scenario: synthetic diagnostic dataset</p><div class="notice">{html.escape(DISCLAIMER)}</div></header><section class="cards">{_cards(journey)}</section><section class="grid">{"".join(charts)}</section><footer>Interpretation: all values are synthetic, configured in versioned YAML, and are not clinical, commercial, or population estimates.</footer></main></body></html>"""
