            ...
            rows.append(
                {
                    ...
                    "definition_version": "PERSISTENCE-SYN-v2.1",
                    "caveat": SYNTHETIC_UNCERTAINTY_CAVEAT,
                }
            )
    return pd.DataFrame(rows)
...
def _scorecard(
    ...
    rows = [
        ...
        _score_dimension(
            ...
            [
                (
                    ...
                    coverage[["diagnosis_date_min", "censor_date_max"]].notna().all().all(),
                ),
        ...
        _score_dimension(
            ...
            [
                ("TASK_SPECIFIC_LEAKAGE", leakage.status.eq("PASS").all()),
        ...
        _score_dimension(
            "Synthetic realism",
            [("SYNTHETIC_REALISM_CHECKS", realism.status.eq("PASS").all())],
        ),
    ]
