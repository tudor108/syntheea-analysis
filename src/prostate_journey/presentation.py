    ...
    *,
    ...
    payload = {
        ...
        "primary_metric": {
            ...
            "numerator_definition": "Eligible synthetic records initiated by day 90.",
            "numerator": primary_metric["initiated_90d_among_eligible"],
            "denominator_definition": "All records meeting the synthetic eligibility rule.",
            "denominator": primary_metric["eligible"],
            "population": "Eligible synthetic records across all configured scenarios.",
            "time_window": "90 days after eligibility",
            "method": "Censor-aware cumulative landmark count and proportion.",
        },
...
def build_presentation_package(
    ...
    _write_evidence_manifest(
        ...
        primary_metric=presentation_metric_map,
    )
