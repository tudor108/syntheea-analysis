...
def write_run_metadata(
    ...
    metadata = {
        ...
        "active_analytical_definition": {
            "eligibility": config["clinical_rule_configuration"]["clinical_rules"][
                "arpi_eligibility"
            ]["version"],
            "initiation": "INITIATION-WINDOW-SYN-v1.0; primary landmark 90 days",
            "persistence": config["prescription"]["definition_version"],
            "persistence_primary_gap_days": config["prescription"]["permissible_gap_days"],
            "persistence_sensitivity_gap_days": config["prescription"]["sensitivity_gaps"],
            "censoring": config["clinical_rule_configuration"]["clinical_rules"][
                "observation_censoring"
            ]["version"],
            "feature_timing": "FEATURE-TIMING-v2.1",
        },
